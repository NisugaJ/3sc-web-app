...
import {
  useNominationsApiContext,
  NominationsApiContext,
} from "./nominationsApiContext";
import type * as Fetcher from "./nominationsApiFetcher";
import { nominationsApiFetch } from "./nominationsApiFetcher";
import type * as Responses from "./nominationsApiResponses";
...
export const useCubeAcademyLogin = (
  ...
  const { fetcherOptions } = useNominationsApiContext();
...
export const useCubeAcademyRetrieveNomineeList = <TData = Responses.Nominee>(
  ...
  const { fetcherOptions, queryOptions, queryKeyFn } =
    useNominationsApiContext(options);
